...
public class PrimitiveCalculator {
    ...
    /*private static List<Integer> suboptimal_sequence(int n) {
        List<Integer> sequence = new ArrayList<Integer>();
        while (n >= 1) {
            sequence.add(n);
            if (n % 3 == 0) {
    ...
    public static void main(String[] args) {
        ...
        /*List<Integer> suboptimal_sequence = suboptimal_sequence(n);
        System.out.println("\n" + (suboptimal_sequence.size() - 1));
        for (Integer x : suboptimal_sequence) {
            System.out.print(x + " ");
        }*/
    }
}
